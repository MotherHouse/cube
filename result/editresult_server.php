...
$sql = "update result set item_list_id='$item_list_id',item_step='$item_step',player_name='$player_name',result1='$result1',result2='$result2',result3='$result3',result4='$result4',result5='$result5' where idresult=$idresult";
