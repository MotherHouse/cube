...
<body>
 ...
 <div class="table-responsive">
  ...
  <table class="table table-hover"><tr><th>五阶</th><th>名次</th><th>姓名</th><th>1</th><th>2</th><th>3</th><th>4</th><th>5</th><th>avg</th><th>pb</th></tr>
...
$sql = "SELECT * FROM result where item_list_id=14 ORDER BY avg ";
...
if ($result->num_rows> 0) {
  ...
  while($row = $result->fetch_assoc()) {
      $i=$i+1;
      echo "<tr><td></td><td>".$i."</td><td>" . $row["item_list_id"]. "</td><td>" . $row["player_name"]. "</td><td> " . $row["result1"]. "</td><td> " . $row["result2"]. "</td><td> " . $row["result3"]. "</td><td> " . $row["result4"]. "</td><td> ". $row["result5"]. "</td>";
            $dnf_times=0;
            $worst=0;
            $pb=0;
            $avg=0;
